...
document.addEventListener("DOMContentLoaded", async () => {
	...
	setupNativeDatePicker('hireDateWrapper', 'hireDate');
	setupNativeDatePicker('leaveDateWrapper', 'leaveDate');
	...
	if (btnSave) {
		btnSave.addEventListener("click", async () => {
			...
			document
				...
				.forEach(tr => {
					const wexCompanyName = tr.querySelector('input[name="wexCompanyName"]')?.value ?? "";
					const wexDept = tr.querySelector('input[name="wexDept"]')?.value ?? "";
					const wexJobTitle = tr.querySelector('input[name="wexJobTitle"]')?.value ?? "";
					const wexHireDate = tr.querySelector('input[name="wexHireDate"]')?.value ?? "";
					const wexLeaveDate = tr.querySelector('input[name="wexLeaveDate"]')?.value ?? "";
					const wexMainDuty = tr.querySelector('input[name="wexMainDuty"]')?.value ?? "";
					const wexSalary = tr.querySelector('input[name="wexSalary"]')?.value ?? "";
