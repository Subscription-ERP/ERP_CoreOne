...
-- ================================
-- TB_DEPT_MASTER 샘플 데이터 INSERT 부서
-- ================================
...
VALUES('DPT00001','0000','CEO',NULL,1,SYSDATE,'0','ADMIN',SYSDATE); -- COMPANY_CODE='0000'

-- 재무총괄 (Level 2)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00002','0000','재무총괄', 'DPT00001',2,SYSDATE,'0','ADMIN',SYSDATE); -- UPPER_DEPT_NO='DPT00001', COMPANY_CODE='0000'

-- 회계부 (Level 3)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00003','0000','회계부','DPT00002',3,SYSDATE,'0','ADMIN',SYSDATE); -- UPPER_DEPT_NO='DPT00002'로 수정, COMPANY_CODE='0000'

-- 재무회계팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00004','0000','재무회계팀','DPT00003',4,SYSDATE,'0','ADMIN',SYSDATE); -- UPPER_DEPT_NO='DPT00003'로 수정, COMPANY_CODE='0000'

-- 관리회계팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00005','0000','관리회계팀','DPT00003',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00005', UPPER_DEPT_NO='DPT00003', COMPANY_CODE='0000'

-- 세무팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00006','0000','세무팀','DPT00003',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00006', UPPER_DEPT_NO='DPT00003', COMPANY_CODE='0000'

-- 운영총괄 (Level 2)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00007','0000','운영총괄','DPT00001',2,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00007', UPPER_DEPT_NO='DPT00001', COMPANY_CODE='0000'

-- 물류부 (Level 3)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00008','0000','물류부','DPT00007',3,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00008', UPPER_DEPT_NO='DPT00007', COMPANY_CODE='0000'

-- 창고관리팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00009','0000','창고관리팀','DPT00008',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00009', UPPER_DEPT_NO='DPT00008', COMPANY_CODE='0000'

-- 배송팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00010','0000','배송팀','DPT00008',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00010', UPPER_DEPT_NO='DPT00008', COMPANY_CODE='0000'

-- 수송관리팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00011','0000','수송관리팀','DPT00008',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00011', UPPER_DEPT_NO='DPT00008', COMPANY_CODE='0000'

-- 자재부 (Level 3)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00012','0000','자재부','DPT00007',3,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00012', UPPER_DEPT_NO='DPT00007', COMPANY_CODE='0000'

-- 구매팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00013','0000','구매팀','DPT00012',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00013', UPPER_DEPT_NO='DPT00012', COMPANY_CODE='0000'

-- 재고관리팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00014','0000','재고관리팀','DPT00012',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00014', UPPER_DEPT_NO='DPT00012', COMPANY_CODE='0000'

-- 자재기획팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00015','0000','자재기획팀','DPT00012',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00015', UPPER_DEPT_NO='DPT00012', COMPANY_CODE='0000'

-- 기술총괄 (Level 2)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00016','0000','기술총괄','DPT00001',2,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00016', UPPER_DEPT_NO='DPT00001', COMPANY_CODE='0000'

-- 개발부 (Level 3)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00017','0000','개발부','DPT00016',3,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00017', UPPER_DEPT_NO='DPT00016', COMPANY_CODE='0000'

-- 시스템운영팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00018','0000','시스템운영팀','DPT00017',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00018', UPPER_DEPT_NO='DPT00017', COMPANY_CODE='0000'

-- ERP개발팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00019','0000','ERP개발팀','DPT00017',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00019', UPPER_DEPT_NO='DPT00017', COMPANY_CODE='0000'

-- 인프라팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00020','0000','인프라팀','DPT00017',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00020', UPPER_DEPT_NO='DPT00017', COMPANY_CODE='0000'

-- 인사총괄 (Level 2)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00021','0000','인사총괄','DPT00001',2,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00021', UPPER_DEPT_NO='DPT00001', COMPANY_CODE='0000'

-- 인사부 (Level 3)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00022','0000','인사부','DPT00021',3,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00022', UPPER_DEPT_NO='DPT00021', COMPANY_CODE='0000'

-- 인재채용팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00023','0000','인재채용팀','DPT00022',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00023', UPPER_DEPT_NO='DPT00022', COMPANY_CODE='0000'

-- 급여/복리후생팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00024','0000','급여/복리후생팀','DPT00022',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00024', UPPER_DEPT_NO='DPT00022', COMPANY_CODE='0000'

-- 교육/평가팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00025','0000','교육/평가팀','DPT00022',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00025', UPPER_DEPT_NO='DPT00022', COMPANY_CODE='0000'

-- 마케팅총괄 (Level 2)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00026','0000','마케팅총괄','DPT00001',2,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00026', UPPER_DEPT_NO='DPT00001', COMPANY_CODE='0000'

-- 마케팅부 (Level 3)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00027','0000','마케팅부','DPT00026',3,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00027', UPPER_DEPT_NO='DPT00026', COMPANY_CODE='0000'

-- 브랜드마케팅팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00028','0000','브랜드마케팅팀','DPT00027',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00028', UPPER_DEPT_NO='DPT00027', COMPANY_CODE='0000'

-- 디지털마케팅팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00029','0000','디지털마케팅팀','DPT00027',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00029', UPPER_DEPT_NO='DPT00027', COMPANY_CODE='0000'

-- CRM/고객분석팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00030','0000','CRM/고객분석팀','DPT00027',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00030', UPPER_DEPT_NO='DPT00027', COMPANY_CODE='0000'

-- 품질부 (Level 2)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00031','0000','품질부','DPT00001',2,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00031', UPPER_DEPT_NO='DPT00001', COMPANY_CODE='0000'

-- 품질검사팀 (Level 4) - Level 3 부서가 없으므로 Level 2(품질부)에 바로 연결하는 대신, Level 3 부서를 임시로 가정하고 연결했습니다.
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00032','0000','품질검사팀','DPT00031',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00032', UPPER_DEPT_NO='DPT00031', COMPANY_CODE='0000'

-- 불량관리팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00033','0000','불량관리팀','DPT00031',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00033', UPPER_DEPT_NO='DPT00031', COMPANY_CODE='0000'

-- 품질개선팀 (Level 4)
INSERT INTO TB_DEPT_MASTER(DEPT_CODE, COMPANY_CODE, DEPT_NAME, UPPER_DEPT_NO, DEPT_LEVEL, START_DATE, STATUS, CREATED_BY, CREATE_DATE)
VALUES('DPT00034','0000','품질개선팀','DPT00031',4,SYSDATE,'0','ADMIN',SYSDATE); -- DEPT_CODE='DPT00034', UPPER_DEPT_NO='DPT00031', COMPANY_CODE='0000'
...
/* ===================================
 * 상위 부서 수정하면 하위 부서도 수정되도록
 * =================================== */
UPDATE tb_dept_master target
SET target.dept_level = (
    -- 1. 새로운 레벨을 계산하는 서브쿼리
    SELECT (#{deptLevel} + level - 1) 
    FROM tb_dept_master
    START WITH dept_code = #{deptCode}    -- 'test' 부서(DPT00035)부터 시작
    CONNECT BY PRIOR dept_code = upper_dept_no -- 계층 구조 탐색
    AND PRIOR company_code = company_code -- 동일 회사 내에서
...
SELECT al.annual_leave_code,
       ...
       um.user_name,
       dm.dept_name,
       FN_FIND_CODENAME('0C',job_title) as job_title,       
       al.grant_year,
       al.total_grant_days,
       al.total_used_days,
       al.remaining_days,
