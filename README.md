...
|:-------------------------------------------------------------:|:-------------------------------------------------------------:|:-------------------------------------------------------------:|:-------------------------------------------------------------:|:-------------------------------------------------------------:|:-------------------------------------------------------------:|
| <img width="100" alt="Image" src="./image/profile/고유한.png" /> | <img width="100" alt="Image" src="./image/profile/이한솔.png" /> | <img width="100" alt="Image" src="./image/profile/우상준.png" /> | <img width="100" alt="Image" src="./image/profile/장준현.png" /> | <img width="100" alt="Image" src="./image/profile/박봉근.png" /> | <img width="100" alt="Image" src="./image/profile/방재우.png" /> |
...
| DB설계 | `11.20 ~ 11.21` | `테이블정의서`, `ERD 작성`,<br/> `공통코드 설계서` |     `ERD`, `테이블정의서`, `공통코드 설계서`      |
|  개발  | `11.24 ~ 12.12` |           `화면구현`, `기능구현`            | `프로그램 목록`, `간트차트`, `개발일지`,<br/> `단위테스트 명세서` |
| 테스트  | `12.17 ~ 12.22` | `초기배포`, `통합테스트`,<br/> `결함 기록 및 수정`  | `통합테스트 시나리오`, `결함대장` |
